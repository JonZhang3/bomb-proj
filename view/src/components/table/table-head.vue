                ...
                <div :class="cellClasses(column)">
                    ...
                    <template v-else>
                        ...
                        <el-popover
                            ...
                            transfer
                            :capture="false"
                            @hide="handleFilterHide(getColumn(rowIndex, index)._index)">
                                <span slot="reference" :class="[prefixCls + '-filter']">
                            ...
                            <div :class="[prefixCls + '-filter-list']"
                                ...
                                <div :class="[prefixCls + '-filter-list-item']">
                                    <el-checkbox-group v-model="getColumn(rowIndex, index)._filterChecked">
                                        <el-checkbox v-for="(item, index) in column.filters" :key="index"
